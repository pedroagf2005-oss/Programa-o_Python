# Todo o material que eu aprendi de python até o momento (03/06/2026)
...
print (f'sua soma é:{soma}' f'sua média é: {média}')
#fim do exercício
...
print(f'a sua área é: {area_retangulo(base,altura)}')
